...
$(".add").on("click", function () {
    ...
    $('<div class="tab-pane" id="tab'+nextTab+'"></div>').appendTo('.tab-content').addClass(hashClass);

    var nextTab2 = $('.tabs2 li').size()+1;
    $('<li class="' + hashClass + '"><a href="#tab' + nextTab2 + '" data-toggle="tab">Zone ' + nextTab2 + '</a></li>').appendTo('.tabs2');
    // $('<div class="tab-pane" id="tab'+nextTab2+'"> </div>').appendTo('.tab-content').addClass(hashClass);
